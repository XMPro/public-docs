...
* [Hardware Requirements](1.-preparation.md#hardware-requirements)
* [Software Requirements](1.-preparation.md#software-requirements)
* [Signing Certificate](1.-preparation.md#signing-certificate)
* [HTTPS/SSL Certificate](1.-preparation.md#https-ssl-certificate)
* [SMTP Account](1.-preparation.md#smtp-account)
* [Twilio Account (Optional)](1.-preparation.md#twilio-account-optional)
...
This section describes the software that must be installed on the server before installing XMPro (refer [2. Install XMPro](2.-install-xmpro/) section), as well as the software required for the post-installation step of installing a Stream Host.
